...
In this project, the skills acquired while learning Python Object-Oriented Programming by coding three connected classes to represent rectangles and squares are put to practise while using the unittest module to test all functionality for each class.This iss in preparation for the AirBnB project which is a big part of the Higher level curriculum
